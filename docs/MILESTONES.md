...
| Knowledge Hub entry point | Added the separately deployed PlantMind Knowledge Hub as an eighth sidebar destination while preserving its independent Docusaurus search and navigation. | App-shell unit test, type check, lint and production build. | COMPLETE LOCALLY; PUBLIC ACCESS PENDING |
