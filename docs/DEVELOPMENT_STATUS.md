...
| Knowledge Hub integration | COMPLETE | Eighth sidebar destination opens the packaged Docusaurus knowledge base at the same-origin `/knowledge-hub` route with its content navigation and local search intact |
...
- **Same-origin Knowledge Hub:** COMPLETE as a packaged Docusaurus/MDX static experience
